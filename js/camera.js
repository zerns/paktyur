...
const { CAMERA_CONSTRAINTS } = await import('./config.js?v=2b8c6cd');
const { features } = await import('./utils.js?v=ef23a8e');
const { frameFromVideo } = await import('./imageProcessor.js?v=69ffa89');
