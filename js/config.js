...
export const VOICE_MAX_RETRIES = 5; // give up auto-restart after this many rapid failures
export const VOICE_HEALTHY_SESSION_MS = 3000; // a recognition session shorter than this, with no result, counts as a failure
export const VOICE_RESTART_BACKOFF_MS = 400; // wait before auto-restarting recognition
